...
import profilePic from "../assets/AtharvImage.jpg";
    ...
    <div className="border-b border-neutral-900 pb-4 lg:mb-36">
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
                <div className="flex justify-center mx-8 ">
                    <motion.img initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:0.5,delay:0.2}} src={profilePic} alt="" />
                </div>
            </div>
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start text-slate-300">
                    ...
                    <motion.span variants={container(0.5)} initial="hidden" animate="visible" transition={{duration:0.5,delay:0.7}} className="mx-8 bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-3xl tracking-tight text-transparent"> Full Stack Developer</motion.span>
